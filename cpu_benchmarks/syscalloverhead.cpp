...
#define LOOP_ITER 5000
#define ENSEMBLE_SIZE 5000

/*
Calculate overhead of entering kernel mode and exiting again 
with a getpid() system call
...
int main()
{
    ...
    for(int j = 0; j < LOOP_ITER; ++j)
    {
        for(int i = 0; i < ENSEMBLE_SIZE; ++i)
        {
            ...
            getpid(); // syscall ID for getpid = 39 (Linux ONLY)
            ...
            // std::cout << times[j][i] << std::endl;
        }
    }

    double timingOverhead = readTimingOverhead();
